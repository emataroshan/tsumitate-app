      ...
      <div className="mb-3 grid min-w-0 gap-3">
        <div className="flex min-w-0 items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="whitespace-nowrap text-lg font-semibold">ファンド選択</div>
              ...
              <div>
                ...
                <ul className="divide-y">
                  {selectedFiltered.map((f) => {
                    ...
                    const referenceAnnualReturn = getReferenceAnnualReturn(f.id);
                          ...
                          >
                            <div className="min-w-0">
                              ...
                              <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
                                ...
                                <div className="rounded-lg bg-slate-50 px-2 py-1">
                                  <div className="text-slate-500">過去5年年率</div>
                                  <div className="font-semibold tabular-nums text-slate-900">
                                    {referenceAnnualReturn == null
                                      ? "-"
                                      : formatPercent(referenceAnnualReturn, 2)}
                                  </div>
                                </div>
                              </div>
                            </div>
          ...
          <tbody>
            {selectedFiltered.length > 0 && (
              <tr className="border-t bg-slate-50/80">
                <td
                  colSpan={4}
                  className="px-3 py-2 text-xs font-semibold tracking-[0.04em] text-slate-600"
                >
                  選択中（{selectedFiltered.length}）
                </td>
              </tr>
